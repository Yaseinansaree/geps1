...
def password(text,chat,bot):
    try:                        
        jd = requests.get('http://api.codebazan.ir/password/?length=20').text
        bot.sendMessage(chat['object_guid'], jd, chat['last_message']['message_id'])
        return True
    except:
        print('code bz server err')
...
def get_pa_na_pa(text,chat,bot):
    try:                        
        jd = requests.get('http://api.codebazan.ir/jok/pa-na-pa/').text
        bot.sendMessage(chat['object_guid'], jd, chat['last_message']['message_id'])
    except:
        print('code bz pa na pa err')
    return True
...
def get_mno(text,chat,bot):                                
    text = open('mno.txt','r').read()
    if chat['abs_object']['type'] == 'Group':
        bot.sendMessage(chat['object_guid'], 'نتایج کامل به پیوی شما ارسال شد', chat['last_message']['message_id'])
        bot.sendMessage(chat['last_message']['author_object_guid'], text)                                        
    elif chat['abs_object']['type'] == 'User':
        bot.sendMessage(chat['object_guid'], text, chat['last_message']['message_id'])
    print('mno guid sended')
...
def get_Instagram(text,chat,bot):                                
    text = open('Instagram.txt','r').read()
    if chat['abs_object']['type'] == 'Group':
        bot.sendMessage(chat['object_guid'], 'نتایج کامل به پیوی شما ارسال شد', chat['last_message']['message_id'])
        bot.sendMessage(chat['last_message']['author_object_guid'], text)                                        
    elif chat['abs_object']['type'] == 'User':
        bot.sendMessage(chat['object_guid'], text, chat['last_message']['message_id'])
    print('Instagram guid sended')
    
def get_tlmj(text,chat,bot):                                
    text = open('tlmj.txt','r').read()
    if chat['abs_object']['type'] == 'Group':
        bot.sendMessage(chat['object_guid'], 'نتایج کامل به پیوی شما ارسال شد', chat['last_message']['message_id'])
        bot.sendMessage(chat['last_message']['author_object_guid'], text)                                        
    elif chat['abs_object']['type'] == 'User':
        bot.sendMessage(chat['object_guid'], text, chat['last_message']['message_id'])
    print('tlmj guid sended')
    
def get_gorh(text,chat,bot):                                
    text = open('gorh.txt','r').read()
    if chat['abs_object']['type'] == 'Group':
        bot.sendMessage(chat['object_guid'], 'نتایج کامل به پیوی شما ارسال شد', chat['last_message']['message_id'])
        bot.sendMessage(chat['last_message']['author_object_guid'], text)                                        
    elif chat['abs_object']['type'] == 'User':
        bot.sendMessage(chat['object_guid'], text, chat['last_message']['message_id'])
    print('gorh guid sended')
    
def get_hanl(text,chat,bot):                                
    text = open('hanl.txt','r').read()
    if chat['abs_object']['type'] == 'Group':
        bot.sendMessage(chat['object_guid'], 'نتایج کامل به پیوی شما ارسال شد', chat['last_message']['message_id'])
        bot.sendMessage(chat['last_message']['author_object_guid'], text)                                        
    elif chat['abs_object']['type'] == 'User':
        bot.sendMessage(chat['object_guid'], text, chat['last_message']['message_id'])
    print('hanl guid sended')
    
def get_mp3(text,chat,bot):                                
    text = open('mp3.txt','r').read()
    if chat['abs_object']['type'] == 'Group':
        bot.sendMessage(chat['object_guid'], 'نتایج کامل به پیوی شما ارسال شد', chat['last_message']['message_id'])
        bot.sendMessage(chat['last_message']['author_object_guid'], text)                                        
    elif chat['abs_object']['type'] == 'User':
        bot.sendMessage(chat['object_guid'], text, chat['last_message']['message_id'])
    print('mp3 guid sended')
    
def get_matn(text,chat,bot):                                
    text = open('matn.txt','r').read()
    if chat['abs_object']['type'] == 'Group':
        bot.sendMessage(chat['object_guid'], 'نتایج کامل به پیوی شما ارسال شد', chat['last_message']['message_id'])
        bot.sendMessage(chat['last_message']['author_object_guid'], text)                                        
    elif chat['abs_object']['type'] == 'User':
        bot.sendMessage(chat['object_guid'], text, chat['last_message']['message_id'])
    print('matn guid sended') 
...
def get_tttt(text,chat,bot):                                
    text = open('tttt.txt','r').read()
    if chat['abs_object']['type'] == 'Group':
        bot.sendMessage(chat['object_guid'], 'نتایج کامل به پیوی شما ارسال شد', chat['last_message']['message_id'])
        bot.sendMessage(chat['last_message']['author_object_guid'], text)                                        
    elif chat['abs_object']['type'] == 'User':
        bot.sendMessage(chat['object_guid'], text, chat['last_message']['message_id'])
    print('tttt guid sended')
...
g_usvl = ''
test_usvl = ''
auth = "ckrpzahhcuacqssfhnrgtxevgsyedlzy"
bot = Bot(auth)
list_message_seened = []
                    ...
                    if 'SendMessages' in access and chat['last_message']['type'] == 'Text' and text.strip() != '':
                        ...
                        if not m_id in list_message_seened:
                            ...
                            if text == '!start':
                                ...
                                try:
                                    bot.sendMessage(chat['object_guid'], 'سلام\nبه سرویس بزرگ چیپس خوش اومدی\n برای استفاده از ربات عضو چنل زیر شو\n @sat_org_2021 \n بعد از عضویت دستور ( help! ) بفرست',chat['last_message']['message_id'])
                                    print('sended response')
                                except:
                                    print('server bug1')
                            if text == 'سلام':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'سلوم‌خوبی؟',chat['last_message']['message_id'])
                                    print('sended response')
                            ...
                            if text == 'قربونت':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'نشی عزیزی',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            if text == 'شکر':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'شکرخدا🤲',chat['last_message']['message_id'])
                                    print('sended response')
                                except:
                                    print('server bug1')
                            if text == 'شب خوش':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'شب شما خوش',chat['last_message']['message_id'])
                                    print('sended response')
                                except:
                                    print('server bug1')
                            if text == 'شب بخیر':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'خوب بخوابی',chat['last_message']['message_id'])
                                    print('sended response')
                                except:
                                    print('server bug1')
                            if text == 'خدافس':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'فعلا عزیز',chat['last_message']['message_id'])
                                    print('sended response')
                                except:
                                    print('server bug1')
                            if text == 'صبح بخیر':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'صبح زیبای شما بخیر',chat['last_message']['message_id'])
                                    print('sended response')
                                except:
                                    print('server bug1')
                            if text == 'اره':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'چه عالی ',chat['last_message']['message_id'])
                                    print('sended response')
                                except:
                                    print('server bug1')
                            if text == 'نه':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'چرا عزیزم الاهی فداتشم',chat['last_message']['message_id'])
                                    print('sended response')
                                except:
                                    print('server bug1')
                            if text == 'سلامتیت':
                            ...
                            if text == 'خبری نیست':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'عه!',chat['last_message']['message_id'])
                                    print('sended response')
                                except:
                                    print('server bug1')
                            if text == 'ممنون':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'خواهش میکنم عزیزم',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            if text == 'ربات':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'من اسم ربا‌ت نیست اسمم چیپس‌ هست',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            if text == 'چیپس':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'جانم عزیزم 😃😍 ',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            if text == 'چه خبر':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'سلامتیت جیگر تو چه خبر؟',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            if text == 'رباتی':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'متاسفانه بله ',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            if text == 'چطوری':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'خوبم',chat['last_message']['message_id'])
                                    print('sended response')
                                except:
                                    print('server bug1')
                            if text == '.':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'اخی نت نداره😢💔',chat['last_message']['message_id'])
                                    print('sended response')
                                except:
                                    print('server bug1')
                            if text == '‌':
                            ...
                            if text == '!ganl':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'درحال حاضر چنلی ثبت نشده...',chat['last_message']['message_id'])
                                    print('sended response')
                            ...
                            if text == 'ارگ':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'به بخش org خوش اومدی\n\nکجاش مشگل داری؟دستور زیر وارد کن👇\n.\n مشگل در بخش لود ست دستور (لود ست )❤️\nمشگل کد افلاین دستور (کد)🤖\nدانلود ست برای ارگ دستور (ست)🔰\nمشگل فنی دستور (فنی)\n\nبهترین چنل ارگ اندروید 😍👇\n 🎵 @sat_org_2021 🎶',chat['last_message']['message_id'])
                                    print('sended response')
                                except:
                                    print('server bug1')
                            if text == '/org':
                            ...
                            if text == 'لود ست':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'لینک زیر بزن👇🙂\nhttps://rubika.ir/sat_org_2021/CBDHEEIIGECBDED',chat['last_message']['message_id'])
                                    print('sended response')
                                except:
                                    print('server bug1')
                            if text == 'لودست':
                            ...
                            if text == 'کد':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'دوست عزیز ارگ مود شد دانلود کن بدون نیاز به کد افلاین😍✅ این ارگ همراه با یک ست عالی هست دانلود کن لینک دانلود پایین👇\n https://rubika.ir/sat_org_2021/CCGIGCBIHFEIDED',chat['last_message']['message_id'])
                                    print('sended response')
                                except:
                                    print('server bug1')
                            if text == 'ست':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'تمام ست ها ارگ اندیورید در چنل زیر گذاشته میشه👇❤️\n 🎶 @Sat_org_2021  🎹',chat['last_message']['message_id'])
                                    print('sended response')
                                except:
                                    print('server bug1')
                            if text == 'فنی':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'سوال های فنی خودت گروه بگو بچه ها جواب میدن😁🤝👇\n https://rubika.ir/joing/BIEGDBFC0DWAPRMSDVBTPFZPSFGFEDXO',chat['last_message']['message_id'])
                                    print('sended response')
                                except:
                                    print('server bug1')
                            if text == '/geps':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'تغییرات درچیپس😃👇\n 🔰تغییر در صبحت\n🔰اضافه شدن چنتا چت\n🔰(جدید) اضافه شدن #اینستادانلود😃\nنسخه ( 8.0)',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                            ...
                            if text == '/sos':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'سلام😃\nامید وارم یادبگیری\nابتدا وارد برنامه اینستا گرام میشی\n بعد لینک فایل کپی میکنی مثل این این عکس👇\n https://rubika.ir/dastoratbot/CFABAGDHIGBCCAC \n\n بعد لینک از کپی وارد ربات چیپس میشی و در بخش اینستا دانلود بخش دانلود فایلتون یا عکس یا فیلم که فرمت هاشون فرق داره(: کلید میکنید\n\nباتشکر ربات چیپس بزرک✅♥️',chat['last_message']['message_id'])
                                    print('sended response')
                                except:
                                    print('server bug1')
                            if text == '/themovie':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'برای دانلود فیلم با کیفیت HD کافیه😃👇\n !download بعد لینک مثلا👇 \n\n !download! https://www.instagram.com/p/BqFuF4lgO9b/?igshid=YmMyMTA2M2Y=',chat['last_message']['message_id'])
                                    print('sended response')
                                except:
                                    print('server bug1')
                            if text == '/Picture':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'برای دانلود عکس با کیفیت HD کافیه😃👇\n !download1  بعد لینک مثلا👇 \n\n !download1 https://www.instagram.com/p/BqFuF4lgO9b/?igshid=YmMyMTA2M2Y=',chat['last_message']['message_id'])
                                    print('sended response')
                                except:
                                    print('server bug1')
                            if text == 'خوبی':
                                print('message geted and sinned')
                                try:
                                    bot.sendMessage(chat['object_guid'], 'اره 🥰',chat['last_message']['message_id'])
                                    print('sended response')    
                                except:
                                    print('server bug1')
                                ...
                                tawd9 = Thread(target=time, args=(text, chat, bot,))
                                tawd9.start()
                            elif text.startswith('ساعت'):
                                tawd9 = Thread(target=time, args=(text, chat, bot,))
                                tawd9.start()
                            elif text.startswith('!password'):
                                tawd9 = Thread(target=password, args=(text, chat, bot,))
                                tawd9.start()
                                ...
                                try:
                                    search = text[10:-1]
                                    if hasInsult(search)[0] == False and chat['abs_object']['type'] == 'Group':
                                        bot.sendMessage(chat['object_guid'], 'نتایج به زودی به پی‌وی شما ارسال میشه', chat['last_message']['message_id'])                           
                                ...
                                tawd38 = Thread(target=get_help, args=(text, chat, bot,))
                                tawd38.start()  
                            elif text.startswith('/Tlmj'):
                                tawd44 = Thread(target=get_tlmj, args=(text, chat, bot,))
                                tawd44.start()                    
                            elif text.startswith('/Ply'):
                                tawd43 = Thread(target=get_Ply, args=(text, chat, bot,))
                                tawd43.start()  
                            elif text.startswith('/Instagram'):
                                tawd43 = Thread(target=get_Instagram, args=(text, chat, bot,))
                                tawd43.start()                        
                            elif text.startswith('/mp3'):
                                tawd43 = Thread(target=get_mp3, args=(text, chat, bot,))
                                tawd43.start()
                            elif text.startswith('/matn'):
                                tawd43 = Thread(target=get_matn, args=(text, chat, bot,))
                                tawd43.start()
                            elif text.startswith('/kanal'):
                                tawd43 = Thread(target=get_hanl, args=(text, chat, bot,))
                                tawd43.start()
                            elif text.startswith('/gorh'):
                                tawd43 = Thread(target=get_gorh, args=(text, chat, bot,))
                                tawd43.start()                                        
                            elif text.startswith('/Entertainment'):
                                tawd39 = Thread(target=get_help1, args=(text, chat, bot,))
                                tawd39.start()
                            elif text.startswith('/meno'):
                                tawd42 = Thread(target=get_mno, args=(text, chat, bot,))
                                tawd42.start()                      
                            elif text.startswith('/Entertainment'):
                                tawd39 = Thread(target=get_help1, args=(text, chat, bot,))
                                tawd39.start()
